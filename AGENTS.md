...
| Domain tools | `src/{rubric,bench,control,model,trace,agentsmd,evidence,metrics,delta,worktree,subagent,ralph,distill,harness,kb,web,mcp,mermaid,plugin}.rs` | architect-specific tooling (see README) |
